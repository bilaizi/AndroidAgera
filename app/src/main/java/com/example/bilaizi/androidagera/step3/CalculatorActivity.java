...
import com.example.bilaizi.androidagera.RepositorySeekBarListener;
import com.example.bilaizi.androidagera.UiUtils;
...
public class CalculatorActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        mResultRepository = Repositories.repositoryWithInitialValue(Result.<String>absent())
                            ...
                            if (operation.isPresent()) {
                                ...
                                switch (operation.get()) {
                                    ...
                                    case R.id.radioButtonDiv:
                                        ...
                                        break;
                                    default:
                                        return Result.failure(new RuntimeException("Invalid operation"));
                                }
                ...
                .compile();
        ((SeekBar) findViewById(R.id.seekBar1)).setOnSeekBarChangeListener(new RepositorySeekBarListener(mValue1Repo));
        ((SeekBar) findViewById(R.id.seekBar2)).setOnSeekBarChangeListener(new RepositorySeekBarListener(mValue2Repo));
